      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg md:rounded-xl shadow-lg mb-6 sm:mb-8 p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
            ...
            <button className="flex items-center space-x-2 px-3 sm:px-4 py-2 border border-slate-600 rounded-lg text-gray-300 hover:bg-slate-700 hover:border-purple-500 transition-all w-full sm:w-auto justify-center sm:justify-start">
              <Edit2Icon size={18} />
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg md:rounded-xl shadow-lg mb-6 sm:mb-8 p-6 sm:p-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
            ...
            <button className="flex items-center space-x-2 px-3 sm:px-4 py-2 border border-slate-600 rounded-lg text-gray-300 hover:bg-slate-700 hover:border-purple-500 transition-all w-full sm:w-auto justify-center">
              <Edit2Icon size={18} />
              <span className="text-sm sm:text-base">Edit</span>
            </button>
          </div>
